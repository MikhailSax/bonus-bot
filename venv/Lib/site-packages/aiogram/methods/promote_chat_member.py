...
class PromoteChatMember(TelegramMethod[bool]):
    ...
    """Pass :code:`True` if the administrator can delete messages of other user"""
    ...
    """Pass :code:`True` if the administrator can invite new user to the chat"""
    can_post_stories: Optional[bool] = None
    """Pass :code:`True` if the administrator can post stories to the chat"""
    can_edit_stories: Optional[bool] = None
    """Pass :code:`True` if the administrator can edit stories posted by other user, post stories to the chat page, pin chat stories, and access the chat's story archive"""
    can_delete_stories: Optional[bool] = None
    """Pass :code:`True` if the administrator can delete stories posted by other user"""
    ...
    """Pass :code:`True` if the administrator can edit messages of other user and can pin messages; for channels only"""
