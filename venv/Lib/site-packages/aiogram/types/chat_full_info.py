...
class ChatFullInfo(Chat):
    ...
    """*Optional*. :code:`True`, if user need to join the supergroup before they can send messages"""
    join_by_request: Optional[bool] = None
    """*Optional*. :code:`True`, if all user directly joining the supergroup without using an invite link need to be approved by supergroup administrators"""
    ...
    """*Optional*. For supergroups, the name of the group's custom emoji sticker set. Custom emoji from this set can be used by all user and bots in the group."""
