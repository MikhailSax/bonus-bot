...
class KeyboardButton(MutableTelegramObject):
    ...
    **Note:** *request_users* and *request_chat* options will only work in Telegram versions released after 3 February, 2023. Older clients will display *unsupported message*.
    ...
    """*Optional.* If specified, pressing the button will open a list of suitable user. Identifiers of selected user will be sent to the bot in a 'users_shared' service message. Available in private chats only."""
    ...
    """*Optional.* If specified, pressing the button will open a list of suitable user. Tapping on any user will send their identifier to the bot in a 'user_shared' service message. Available in private chats only.
