...
class ReplyKeyboardMarkup(MutableTelegramObject):
    ...
    """*Optional*. Use this parameter if you want to show the keyboard to specific user only. Targets: 1) user that are @mentioned in the *text* of the :class:`aiogram.types.message.Message` object; 2) if the bot's message is a reply to a message in the same chat and forum topic, sender of the original message."""
