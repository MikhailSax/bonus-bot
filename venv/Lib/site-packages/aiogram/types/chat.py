...
.. deprecated:: API:7.3
   https://core.telegram.org/bots/api-changelog#may-6-2024"""
    ...
    """*Optional*. For supergroups, the name of the group's custom emoji sticker set. Custom emoji from this set can be used by all user and bots in the group. Returned only in :class:`aiogram.methods.get_chat.GetChat`.
...
.. deprecated:: API:7.3
   https://core.telegram.org/bots/api-changelog#may-6-2024"""
    ...
    """*Optional*. :code:`True`, if all user directly joining the supergroup need to be approved by supergroup administrators. Returned only in :class:`aiogram.methods.get_chat.GetChat`.

.. deprecated:: API:7.3
   https://core.telegram.org/bots/api-changelog#may-6-2024"""
    join_to_send_messages: Optional[bool] = Field(None, json_schema_extra={"deprecated": True})
    """*Optional*. :code:`True`, if user need to join the supergroup before they can send messages. Returned only in :class:`aiogram.methods.get_chat.GetChat`.
   ...
   https://core.telegram.org/bots/api-changelog#may-6-2024"""
    ...
    def edit_invite_link(
        ...
        **kwargs: Any,
        ...
        :param member_limit: The maximum number of user that can be members of the chat simultaneously after joining the chat via this invite link; 1-99999
        :param creates_join_request: :code:`True`, if user joining the chat via the link need to be approved by chat administrators. If :code:`True`, *member_limit* can't be specified
    ...
    def get_member(
        ...
        **kwargs: Any,
        ...
        Use this method to get information about a member of a chat. The method is only guaranteed to work for other user if the bot is an administrator in the chat. Returns a :class:`aiogram.types.chat_member.ChatMember` object on success.
    ...
    def promote(
        ...
        **kwargs: Any,
        ...
        :param can_delete_messages: Pass :code:`True` if the administrator can delete messages of other user
        ...
        :param can_invite_users: Pass :code:`True` if the administrator can invite new user to the chat
        :param can_post_stories: Pass :code:`True` if the administrator can post stories to the chat
        :param can_edit_stories: Pass :code:`True` if the administrator can edit stories posted by other user, post stories to the chat page, pin chat stories, and access the chat's story archive
        :param can_delete_stories: Pass :code:`True` if the administrator can delete stories posted by other user
        ...
        :param can_edit_messages: Pass :code:`True` if the administrator can edit messages of other user and can pin messages; for channels only
